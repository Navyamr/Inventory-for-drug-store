...
Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con = DriverManager.getConnection ("jdbc:mysql://localhost:3306/drug_store_inventory","root","root");
...
datacon.result = datacon.st.executeQuery("select Name, password from employee where Name='"+Username+"' and password='"+password+"'");

user = new Employee();
user.setName(datacon.result.getString("Name"));
user.password(datacon.result.getString("password"));
}
        catch(Exception e)
{
System.out.println(e.getMessage());
